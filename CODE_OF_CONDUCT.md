...
## Our Pledge
While Translational Analytics and Statistics predominantly have closed source code licensed for profit, we operate under the same covenant open source projects.
...
Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by contacting the project team at opensource@microsoft.com. The project team will look over and investigate all complaints and respond in a way that's appropriate to the circumstances. The project team has to maintain confidentiality concerning the reporter of an incident. Further details of specific enforcement policies may be posted separately.
...
This Code of Conduct is adapted from the [Microsoft FAST][stack] and [Contributor Covenant][homepage], version 1.4, available at [https://contributor-covenant.org/version/1/4][version].

[stack]: https://raw.githubusercontent.com/microsoft/fast/master/CODE_OF_CONDUCT.md
